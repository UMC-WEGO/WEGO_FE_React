...
function TempContainer({ temperature }: TempContainerProps) {
  ...
  const progressBarWidth = (temperature / 100) * 93.5;
  ...
  return (
    <S.TempContainer>
      <S.TempHeader>
        ...
        <S.TempGrade>
          <img
            src={getGrade(temperature).imageUrl}
            alt={getGrade(temperature).grade}
          />
