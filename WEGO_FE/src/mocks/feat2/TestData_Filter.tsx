...
import clock_icon from "../../images/feat2/alarm_icon.png";
  ...
  export const location = [
    ...
    { name: "전라북도", elements: ["전주시", "군산시", "남원시", "부안군"] },
    { name: "전라남도", elements: ["여수시", "순천시", "담양군", "목포시"] },
    { name: "경상북도", elements: ["경주시", "포항시", "안동시", "문경시"] },
    { name: "경상남도", elements: ["창원시", "통영시", "거제시", "김해시"] },
    { name: "충청북도", elements: ["단양군", "청주시", "충주시", "제천시"] },
    { name: "충청남도", elements: ["천안시", "보령시", "공주시", "아산시"] },
